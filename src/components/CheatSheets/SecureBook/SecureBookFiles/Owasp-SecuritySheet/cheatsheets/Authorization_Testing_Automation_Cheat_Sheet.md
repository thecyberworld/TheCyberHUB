...
This article describes a proposition of implementation in order to automate the tests of an _authorization matrix_.
...
In order to achieve the full automation of the evaluation of the _authorization matrix_, the following actions have been performed:
