...
Spring MVC will then look up a message with ID _article.title.error_ in a defined MessageSource. More on this [documentation](https://www.silverbaytech.com/2013/04/16/custom-messages-in-spring-validation/).
