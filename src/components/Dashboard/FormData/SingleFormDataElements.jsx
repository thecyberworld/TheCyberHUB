...
export const FormDetailsHero = styled.div`
    display: flex;
    justify-content: space-between;
    align-items: start;
`;

export const FormDetailsHeader = styled.div`
    display: flex;
    flex-direction: column;
...
export const FormDetailsRole = styled.div`
    display: flex;
    column-gap: 0.5rem;
`;

export const FormDetailsRoleTitle = styled.span`
    font-weight: 500;
    letter-spacing: 0.1rem;
`;

export const FormDetailsRating = styled.span`
    display: inline-flex;
    column-gap: 0.2rem;
    align-items: center;
    font-weight: bold;
...
export const FormDetailsLocation = styled.div`
    & > span {
        font-weight: 300;
    }
`;
...
export const FormDetailsReq = styled.div`
    display: flex;
    flex-direction: column;
`;
...
export const FormDescSection = styled.div`
    margin: 10px 0;
`;
