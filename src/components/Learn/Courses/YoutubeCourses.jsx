...
export const CyberSecurityCourses = () => {
  return (
    <div className={"card__section"} id={"id"}>
      ...
      <div className="container">{CyberYoutubeVideosCard}</div>
    </div>
  );
};
export const BugHuntingCourses = () => {
  return (
    <div className={"card__section"} id={"id"}>
      ...
      <div className="container">{BugHuntingVideosCard}</div>
    </div>
  );
};
export const RedTeamCourses = () => {
  return (
    <div className={"card__section"} id={"id"}>
      ...
      <div className="container">{RedTeamCoursesCard}</div>
    </div>
  );
};
export const BlueTeamCourses = () => {
  return (
    <div className={"card__section"} id={"id"}>
      ...
      <div className="container">{BlueTeamCoursesCard}</div>
    </div>
  );
};
