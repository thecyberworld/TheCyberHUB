const useCommandType = function (commandType, elements) {
    return elements.map((element) => ({
        ...element,
        meta: [...element.meta, commandType],
    }));
};

export const ShellCommands = () => {
    const shellCommands = {
        ReverseShell: useCommandType(CommandType.ReverseShell, [
            {
                name: "Bash -i",
        ...
        BindShell: useCommandType(CommandType.BindShell, [
            {
                name: "Python3 Bind",
                command:
        ...
        MSFVenom: useCommandType(CommandType.MSFVenom, [
            {
        ...
        HoaxShell: useCommandType(CommandType.HoaxShell, [
            {
    ...
    const rsgData = {
        ...
        shellCommands: [
            shellCommands.BindShell,
            shellCommands.ReverseShell,
            shellCommands.MSFVenom,
            shellCommands.HoaxShell,
        ],
    };
