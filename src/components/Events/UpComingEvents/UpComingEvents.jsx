        ...
        <>
            <UpComingEventsContainer>
                <UpComingEvents_Title>
                    ...
                    <UpComingEvents_SubHeading>
                        {props.date} • <UpComingEvents_DiscordLink href={props.venue} target={"_blank"}> Discord </UpComingEvents_DiscordLink>
                    </UpComingEvents_SubHeading>
                </UpComingEvents_Title>
                <UpComingEvents_Content>
                    {viewFull ? props.content : props.content.slice(0, 200) + "..."}<br></br>
                    <UpComingEvents_ChangeViewBtn onClick={() => {setViewFull(!viewFull)}}>
