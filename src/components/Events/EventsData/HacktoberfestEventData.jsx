import {List, ListContent} from "../../Prep/InterviewQuestions/InterviewQuestionsElements";
...
const HacktoberfestEventData = {
    ...
    content:
        <p>
            Go through the Hacktoberfest 2022 contributor section to know more about what you should do and the rewards
            you will receive. We would be genuinely happy if you choose the “plant a tree” option as your reward. <br/>
            Contributions/pull requests can be made to the following repositories under the <b><Link
            href={"https://github.com/thecyberworld/"} target={"_blank"}> Thecyberworld </Link></b> organization: <br/>
            ...
            href={"https://github.com/thecyberworld"} target={"_blank"}> Thecyberworld </Link> </b> and work on those
            issues.
