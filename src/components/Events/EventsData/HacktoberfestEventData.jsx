...
import { Heading, ListContent, List, Link } from "../../Learn/Roadmaps/RoadmapsElements";
    ...
    content: (
      <>
        <p>
          ...
          Read the{" "}
          <Link href={"https://github.com/thecyberworld/thecyberhub.org/blob/main/CONTRIBUTING.md"} target={"_blank"}>
            {" "}
          ...
          on the main Thecyberworld org. If you would like to challenge yourself, you can create some issues and
          ...
          <div style={{ margin: "10px 20px" }}>
            <ListContent>
              ...
              <List>
                {" "}
                GitHub:{" "}
                <Link href={"https://github.blog/2015-01-21-how-to-write-the-perfect-pull-request/"} target={"_blank"}>
                  {" "}
                  Write good PRs{" "}
                </Link>
              </List>
