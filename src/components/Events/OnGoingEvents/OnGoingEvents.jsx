        ...
        <>
            <OnGoingEventsContainer>
                <OnGoingEvents_Title>
                    ...
                    <OnGoingEvents_SubHeading>
                        {props.date} • <OnGoingEvents_DiscordLink href={props.venue} target={"_blank"}> Discord </OnGoingEvents_DiscordLink>
                    </OnGoingEvents_SubHeading>
                    <OnGoingEvents_Heading>{props.title}</OnGoingEvents_Heading>
                </OnGoingEvents_Title>
                <OnGoingEvents_Content>
                    {viewFull ? props.content : props.content.slice(0, 200) + "..."}<br></br>
                    <OnGoingEvents_ChangeViewBtn onClick={() => {setViewFull(!viewFull)}}>
