        ...
        <ResourcesListSection>
            ...
            <ListContent>
                <List><Link
                    ...
                    target={"_blank"}>Basic IT Skills</Link></List>
            ...
            <ListContent>
                ...
                <List><Link href={"https://www.netacad.com/courses/packet-tracer"} target={"_blank"}>NetCad Packet
                    Tracer</Link></List>
            </ListContent>
            ...
            <ListContent>
                ...
                <List><Link href={"https://youtu.be/qwA6MmbeGNo"} target={"_blank"}>Open-Source
                    Intelligence</Link></List>
            </ListContent>
            ...
            <ListContent>
                ...
                <List><Link href={"https://www.youtube.com/playlist?list=PLBf0hzazHTGO3EpGAs718LvLsiMIv9dSC"}
                            target={"_blank"}>Web App Penetration Testing Tutorials</Link></List>
            </ListContent>

            <Heading> Bug Hunting </Heading>
            <ListContent>
                <List><Link href={"https://www.youtube.com/watch?v=hDYqWZ11njU&list=PLbyncTkpno5FAC0DJYuJrEqHSMdudEffw"}
                            target={"_blank"}>New to bug hunting</Link></List>
                <List><Link href={"https://www.youtube.com/watch?v=yCUQBc2rY9Y&list=PLbyncTkpno5HqX1h2MnV6Qt4wvTb8Mpol"}
                            target={"_blank"}>Everything API Hacking</Link></List>
                <List><Link href={"https://www.youtube.com/playlist?list=PLF7JR1a3dLONdkRYU_8-5OcgOzrWe2549"}
                            target={"_blank"}>Bug bounty / webapp pentesting tutorials</Link></List>
                <List><Link href={"https://www.youtube.com/c/RanaKhalil101/videos"} target={"_blank"}>Web Security
                    Academy</Link></List>
                <List><Link href={"https://www.youtube.com/playlist?list=PLhfP6zOcRP1f_FyWc_gk1fRz1mxst0QE5"}
                            target={"_blank"}>Guide to Failing at Bug Bounties</Link></List>
                <List><Link href={"https://www.youtube.com/playlist?list=PLhfP6zOcRP1fXtBtxhTlu9KR-PKDA6biX"}
                            target={"_blank"}>What after Recon?</Link></List>
                <List><Link href={"https://www.youtube.com/playlist?list=PLhfP6zOcRP1dCTjbENt4ilFKFwFpspOoS"}
                            target={"_blank"}>No BS Guides</Link>
                </List>
            </ListContent>

            <Heading> Practice / Learn - Web App Pen-testing </Heading>
            <ListContent>
                <List><Link href={"https://portswigger.net/web-security/learning-path"} target={"_blank"}>Web Security
                    Academy</Link></List>
            ...
            <ListContent>
                ...
                <List><Link href={"https://www.facebook.com/whitehat"}
                            target={"_blank"}>facebook.com/whitehat</Link></List>
