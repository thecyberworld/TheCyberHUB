...
export const JobsData = [
  {
    ...
    jobReq: [
      <>
        Technical expertise in data models, database design development, data
        mining, and segmentation technique.
      </>,
      <>
        Strong knowledge of and experience with reporting packages (Business
        Objects, etc.), databases...
      </>,
    ],
    jobTimeline: {
  ...
  },
  {
    ...
    jobReq: [
      ...
      <>
        Research relevant facts and details to drive informative, engaging, and
